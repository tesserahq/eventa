...
DEFAULT_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/eventa"
DEFAULT_TEST_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/eventa_test"
