...
class LoggingConfig:
    ...
    def _configure_logging(self):
        ...
        loggers = {
            ...
            "fastapi": log_level,
            "celery": log_level,
            "eventa": log_level,  # For general app logging
        ...
        for logger_name, level in loggers.items():
            ...
            if logger_name in ["eventa", "app", "celery"]:
    ...
    def logger(self) -> logging.Logger:
        ...
        return logging.getLogger("eventa")
...
def get_logger(name: str = "eventa") -> logging.Logger:
    """Get a logger instance with the given name."""
